        ...
        <div id="content" class="span10">
            ...
            <ul class="breadcrumb">
                <li>
                    ...
                    <i class="icon-angle-right"></i>
                    <a href="threads.html">subForumName</a>
                    <i class="icon-angle-right"></i>
                    <a href="comment.html">threadName</a>
                    <i class="icon-angle-right"></i>
                </li>
            ...
            <div>
                ...
                <div class="box span12">
                    ...
                    <div class="box-content">
                        <form class="form-horizontal" action="/addSubForum" method="get">
                            <fieldset>
...
<!--
<form id="frm" action="/addSubForum" method="get">
  <p>
    Open New Sub Forum
  </p><br>
  <label>
