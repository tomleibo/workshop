            ...
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
              ...
              <% for(FriendRequest fr : user.getFriendRequests()){%>
                  <tr>
                    ...
                    <td class="center">
                      <button data-brackets-id="13985" href="\replyToFriendRequest?friendReqId=<%=fr.id%>&answer=1" class="btn btn-mini btn-success">Accept</button>
                      <button data-brackets-id="13985" href="\replyToFriendRequest?friendReqId=<%=fr.id%>&answer=0" class="btn btn-mini btn-danger">Deny</button></td>
                  </tr>
              <%}%>
              </tbody>
            </table>
